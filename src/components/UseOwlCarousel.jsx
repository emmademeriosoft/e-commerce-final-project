...
const UseOwlCarousel = () => {
    ...
    return (
        <div className="container-fluid">
            <OwlCarousel autoplay={true} responsive={{
                    0:{
                        items:1
                    },
                    600:{
                ...
                } smartSpeed={1000} autoplayTimeout={3000} autoplayHoverPause={true} className='owl-theme' loop margin={10} items={4} dots={false} nav navText={['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>']}>
                <div className="item">
